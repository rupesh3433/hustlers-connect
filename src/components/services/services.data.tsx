...
export const IconMarketing = ({ c }: { c: string }) => (
  <Ico c={c}>
    <polyline points="4,38 14,26 22,32 32,16 44,10"
    ...
    <line x1="4" y1="42" x2="44" y2="42" stroke={c} strokeWidth="1.5" opacity=".25" />
  </Ico>
);
...
export const IconGraphics = ({ c }: { c: string }) => (
  <Ico c={c}>
    ...
    <path d="M24 9C24 9 33 16.5 33 24S24 39 24 39 15 31.5 15 24 24 9 24 9Z"
      stroke={c} strokeWidth="1.5" opacity=".42" />
...
export const VisualWeb = ({ a, d }: { a: string; d: string }) => (
  <svg viewBox="0 0 380 280" fill="none" width="100%" height="100%">
    ...
    {/* Browser frame */}
    <rect x="40" y="22" width="300" height="198" rx="10" fill="url(#gw2)" stroke={a} strokeWidth="1.2" opacity=".5" />
...
export const VisualMarketing = ({ a, d }: { a: string; d: string }) => (
  <svg viewBox="0 0 380 280" fill="none" width="100%" height="100%">
    <defs>
    ...
    <line x1="42" y1="256" x2="282" y2="256" stroke={a} strokeWidth="1.4" opacity=".22" />
    {/* Up arrow */}
    <polyline points="284,42 314,12 344,42"
      stroke={a} strokeWidth="2.4" strokeLinecap="round" fill="none" opacity=".92" />
    <line x1="314" y1="12" x2="314" y2="88"
      stroke={a} strokeWidth="2.4" strokeLinecap="round" opacity=".92" />
    {/* Metric card */}
    <rect x="32" y="30" width="130" height="64" rx="9" fill="#040413" stroke={a} strokeWidth="1.4" opacity=".92" />
    <text x="48" y="65" fontFamily="monospace" fontSize="22" fill={a} opacity=".95">+248%</text>
    <text x="48" y="82" fontFamily="'DM Sans',sans-serif" fontSize="10" fill={a} opacity=".48">Growth Rate</text>
    {/* Trend line */}
    <polyline points="42,220 80,195 120,205 165,165 210,150 255,110"
      stroke={a} strokeWidth="1.5" strokeDasharray="4 3" opacity=".35" />
  </svg>
);

export const VisualSocial = ({ a, d }: { a: string; d: string }) => (
  <svg viewBox="0 0 380 280" fill="none" width="100%" height="100%">
    <defs>
    ...
    {/* Network nodes */}
    {([
      [190,140, 13, 0.85], [105,82,  9, 0.42], [278,76,  9, 0.42],
      [62, 190, 7, 0.32],  [320,190, 7, 0.32], [190,248, 7, 0.32],
      [142,38,  5, 0.22],  [260,234, 5, 0.22],
    ] as [number,number,number,number][]).map(([x,y,r,op],i) => (
      <circle key={i} cx={x} cy={y} r={r} fill={a} opacity={op} />
    ))}
    {/* Connections */}
    {([
      [190,140,105,82], [190,140,278,76], [190,140,62,190],
      [190,140,320,190],[190,140,190,248],[105,82,142,38],[278,76,260,234],
    ] as [number,number,number,number][]).map(([x1,y1,x2,y2],i) => (
      <line key={i} x1={x1} y1={y1} x2={x2} y2={y2}
        stroke={a} strokeWidth="1.1" opacity=".25" />
    ))}
    {/* Ping rings on central node */}
    <circle cx="190" cy="140" r="24" stroke={a} strokeWidth="1" opacity=".2" />
    <circle cx="190" cy="140" r="36" stroke={a} strokeWidth="0.8" opacity=".12" />
    {/* Card */}
...
export const VisualGraphics = ({ a, d }: { a: string; d: string }) => (
  <svg viewBox="0 0 380 280" fill="none" width="100%" height="100%">
    ...
    {/* Concentric circles */}
    <circle cx="178" cy="140" r="92" stroke={a} strokeWidth="1.2" opacity=".32" strokeDasharray="6 4"/>
    <circle cx="178" cy="140" r="62" stroke={a} strokeWidth="1"   opacity=".22" />
    <circle cx="178" cy="140" r="32" fill={a} opacity=".1" />
    {/* Triangle */}
    <polygon points="178,62 260,200 96,200"
      stroke={a} strokeWidth="1.8" fill="none" opacity=".44" />
    ...
    {/* Swatches */}
    {[[40,214,a,0.75],[72,202,d,0.62],[104,220,"#EF4444",0.55],[136,208,"#818CF8",0.48]].map(([x,y,f,op],i)=>(
      <rect key={i} x={x as number} y={y as number} width="24" height="56" rx="4"
        fill={f as string} opacity={op as number} />
    ))}
    {/* Pencil stroke */}
...
export const SERVICES: ServiceItem[] = [
  ...
  },
  {
    ...
    visual: <VisualMarketing a="#A78BFA" d="#6D28D9" />,
  },
  {
    id: 3,
    label: "Social Media",
    ...
    visual: <VisualSocial a="#818CF8" d="#3730A3" />,
  },
  {
    id: 4,
    label: "Graphics",
